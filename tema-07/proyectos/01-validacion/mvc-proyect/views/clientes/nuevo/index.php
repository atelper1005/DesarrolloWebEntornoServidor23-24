    ...
    <div class="container">
        ...
        <form action="<?= URL ?>clientes/create" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control <?= (isset($this->errores['email']))? 'is-invalid': null ?>" name="email" value="<?=$this->cliente->email?>">
                <!-- Mostrar posible error -->
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control <?= (isset($this->errores['dni']))? 'is-invalid': null ?>" name="dni" value="<?=$this->cliente->dni?>">
                <!-- Mostrar posible error -->
