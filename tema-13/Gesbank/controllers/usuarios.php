...
class Usuarios extends Controller
{
    ...
    function create($param = [])
    {
        ...
        if (!isset($_SESSION['id'])) {
            ...
            $confirmarpassword = filter_var($_POST['confirmarpassword'] ??= '', FILTER_SANITIZE_SPECIAL_CHARS);
            ...
            //confirmarpassword: Obligatorio
            if (empty($confirmarpassword)) {
                $errores['confirmarpassword'] = 'El campo de confirmación de password es obligatorio';
            }
            ...
            if (!empty($errores)) {
                ...
                $this->model->create($nombre, $email, $password, $roles);
    ...
    # Método editar
    # Permite editar los datos de los usuarios registrados
    ...
    public function update($param = [])
    {
        ...
        $confirmPassword = filter_input(INPUT_POST, 'confirmarpassword', FILTER_SANITIZE_SPECIAL_CHARS);
        ...
        if (!empty($password) || !empty($confirmPassword))
        {
            ...
            {
                $errores['confirmarpassword'] = 'Las passwords no coinciden';
            }
        }
